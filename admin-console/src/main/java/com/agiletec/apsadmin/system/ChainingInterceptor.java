 ...
 * stack to the currently executing object, except for any object that
 * implements {@link Unchainable}. A collection of optional <i>includes</i> and
 * <i>excludes</i> may be provided to control how and which parameters are
 * copied. Only includes or excludes may be specified. Specifying both results
 * in undefined behavior. See the javadocs for {@link ReflectionProvider#copy(Object, Object,
 ...
 * <br><b>One</b>, you can safely apply it to all your actions without any worry
 * of adverse affects.
 * <br><b>Two</b>, it is up to you to ensure an object exists in the stack prior
 * to invoking this action. The most typical way this is done is through the use
 * of the <b>chain</b> result type, which combines with this interceptor to make
 * up the action chaining feature.
 * </p>
 *
 * <p>
 * <b>Note:</b> By default Errors, Field errors and Message aren't copied during
 * chaining, to change the behaviour you can specify the below three constants
 * in struts.properties or struts.xml:
 * </p>
 *
 * <ul>
 * <li>struts.xwork.chaining.copyErrors - set to true to copy Action Errors</li>
 * <li>struts.xwork.chaining.copyFieldErrors - set to true to copy Field
 * Errors</li>
 * <li>struts.xwork.chaining.copyMessages - set to true to copy Action
 * Messages</li>
 * </ul>
 *
 * <p>
 ...
 * <ul>
 * <li>excludes (optional) - the list of parameter names to exclude from copying
 * (all others will be included).</li>
 * <li>includes (optional) - the list of parameter names to include when copying
 * (all others will be excluded).</li>
 * </ul>
