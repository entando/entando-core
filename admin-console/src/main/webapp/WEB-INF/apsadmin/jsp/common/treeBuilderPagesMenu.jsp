...
<tr id="<s:property value="#currentRoot.code" />" data-parent="#<s:property value="#currentRoot.parent.code" />" class="treeRow <s:if test="%{!#currentRoot.isRoot() && #isHidden}">collapsed childrenNodes</s:if>" >
