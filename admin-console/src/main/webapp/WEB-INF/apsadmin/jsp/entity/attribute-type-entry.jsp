...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
    ...
    <s:if test="strutsAction == 2">
        <li class="page-title-container"> <s:text name="title.attribute.edit"/></li>
        </s:if>
        <s:else>
        <li class="page-title-container"><s:text name="title.attribute.new"/></li>
        </s:else>
</ol>
...
<s:form action="saveAttribute" cssClass="form-horizontal">
    ...
    <fieldset class="col-xs-12">
        ...
        <div class="form-group">
            ...
            <label class="col-sm-2 control-label" for="attributeName"><s:text name="label.code" />
                <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
                    <span class="fa fa-info-circle"></span></a>
            </label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="attributeDescription"><s:text name="label.description" />
                <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
                    <span class="fa fa-info-circle"></span></a>
            </label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="required"><s:text name="Entity.attribute.flag.mandatory.full" />
                <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
        ...
        <div class="form-group">
            <s:if test="!(#attribute.type == 'List') && !(#attribute.type == 'Monolist')">
                <s:if test="isEntityManagerSearchEngineUser() && isIndexableOptionSupported(attributeTypeCode)">
                    <label class="col-sm-2 control-label"for="indexable"><s:text name="Entity.attribute.flag.indexed.full" />
                        <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
                            <span class="fa fa-info-circle"></span></a>
                    </label>
                    <div class="col-sm-10">
                ...
                <s:if test="isSearchableOptionSupported(attributeTypeCode)">
                    <label class="col-sm-2 control-label" for="searchable"><s:text name="Entity.attribute.flag.searchable.full" />
                        <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
                            <span class="fa fa-info-circle"></span></a>
                    </label>
                    <div class="col-sm-10">
    ...
    <fieldset class="col-xs-12">
        ...
        <legend><s:text name="name.roles" /></legend>
        ...
        <s:else>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="attributeRoleName"><s:text name="name.role" />
                    <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
                        <span class="fa fa-info-circle"></span></a>
                </label>
                <div class="col-sm-10">
    ...
    <s:if test="null != #attributeDisablingCodesVar && #attributeDisablingCodesVar.size()>0">
        <fieldset class="col-xs-12">
            <legend><s:text name="name.disablingCodes" />
            </legend>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="disablingCode"><s:text name="label.code" />
                    <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
                        <span class="fa fa-info-circle"></span></a>
                </label>
                <div class="col-sm-10">
    ...
    <s:if test="#attribute.type == 'List' || #attribute.type == 'Monolist'">
        <fieldset class="col-xs-12 lol">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="listNestedType"><s:text name="Entity.attribute.setting.listType" />
                    <a role="button" tabindex="0" data-toggle="popover" data-trigger="focus" data-html="true" title="" data-placement="top" data-content="to be inserted   " data-original-title="">
                        <span class="fa fa-info-circle"></span></a>
                </label>	
                <div class="col-sm-10">
