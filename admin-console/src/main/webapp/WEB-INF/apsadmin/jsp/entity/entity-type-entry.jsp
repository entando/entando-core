...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
	...
	<s:if test="operationId == 1">
		<li class="page-title-container"><s:text
				name="title.entityTypes.editType.new" /></li>
	</s:if>
	<s:else>
		<li class="page-title-container"><s:text
				name="title.entityTypes.editType.edit" /></li>
	</s:else>
</ol>
...
<div id="main" role="main">
	...
	<s:form action="saveEntityType" cssClass="form-horizontal">
		...
		<fieldset class="col-xs-12">
			...
			<div class="form-group">
				<s:if test="operationId == 1">
					...
					<div class="col-sm-10">
						<wpsf:textfield name="entityTypeCode" id="entityTypeCode"
							value="%{#entityType.typeCode}" cssClass="form-control" />
					</div>
				</s:if>
				<s:else>
					<label class="col-sm-2 control-label" for="entityTypeCode"><s:text
			...
			<div class="form-group">
				<label class="col-sm-2 control-label"><s:text
						name="label.name" /> <a role="button" tabindex="0"
					data-toggle="popover" data-trigger="focus" data-html="true"
					title="" data-placement="top" data-content="to be inserted   "
					data-original-title=""> <span class="fa fa-info-circle"></span></a>
				</label>
				<div class="col-sm-10">
					<wpsf:textfield name="entityTypeDescription"
						id="entityTypeDescription" value="%{#entityType.typeDescr}"
		...
		<s:if test="null != #hookpoint_plugin_code">
			<s:include
				value="%{'/WEB-INF/plugins/' + #hookpoint_plugin_code + '/apsadmin/jsp/entity/include/entity-type-entry.jsp'}" />
		</s:if>
		...
		<fieldset class="col-xs-12">
			...
			<s:include
				value="/WEB-INF/apsadmin/jsp/entity/include/attribute-operations-add.jsp" />
			<s:include
				value="/WEB-INF/apsadmin/jsp/entity/include/attribute-list.jsp" />
		</fieldset>
		<fieldset class="col-xs-12">
			<div class="form-group">
				<div class="col-xs-12">
					<wpsf:submit type="button" cssClass="btn btn-primary  pull-right "
						action="saveEntityType">
