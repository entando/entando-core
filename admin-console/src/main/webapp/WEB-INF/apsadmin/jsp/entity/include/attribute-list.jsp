...
<s:if test="null != entityType.attributeList && entityType.attributeList.size() > 0">
    ...
    <div class="col-sm-10 table-in-col10">
        <div class="table-responsive overflow-visible">
            <table class="table table-striped table-bordered" id="fagiano_entityTypesList">
                <tr>
                    <th style="width: 100px;"><s:text name="label.code" /></th>
                    <th style="width: 159px;"><s:text name="label.type" /></th>
                    <th><s:text name="name.roles" /></th>
                    <th style="width: 59px;"><s:text name="label.mandatory" /></th>
                    <th style="width: 59px;"><s:text name="label.filter" /></th>
                        ...
                        <td class="text-center">
                            <div class="dropdown dropdown-kebab-pf">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownKebabRight">
                                    <li> <wpsa:actionParam action="editAttribute" var="actionName" >
                                            <wpsa:actionSubParam name="attributeName" value="%{#attribute.name}" />
                                        </wpsa:actionParam>
                                        <wpsf:submit action="%{#actionName}" type="button" title="%{getText('label.edit')}: %{#attribute.name}" cssClass="btn-no-button" >
