...
<h1 class="page-title-container"><s:text name="%{'note.' + entityManagerName + '.intro.2'}" />
    ...
    <div class="table-responsive overflow-visible">
        <table class="table table-bordered table-hover table-treegrid" style="margin-top: 1em;">
            ...
            <s:iterator value="entityPrototypes" var="entityType" status="counter">
                ...
                <tr>
                    <td><code><s:property value="#entityType.typeCode" /></code> </td>
                    ...
                    <td class="text-center text-nowrap">
                        <div class="dropdown dropdown-kebab-pf">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownKebabRight">
                                <li>
                                    <%-- edit --%>
                                    <a class="" id="<s:property value="#entityAnchor" />" href="
                                ...
                                <li>
                                    <a href="
                                       ...
                                       " title="<s:text name="label.remove" />: <s:property value="#entityType.typeDescr" />" class="">
