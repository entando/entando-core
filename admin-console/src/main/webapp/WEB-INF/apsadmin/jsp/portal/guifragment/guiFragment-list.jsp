		...
		<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div id="search-advanced" class="collapse well collapse-input-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<wpsf:select name="pluginCode" id="guiFragment_pluginCode" 
							headerKey="" headerValue="%{getText('label.all')}" 
							list="guiFragmentPlugins" listKey="key" listValue="value" cssClass="form-control" />
					</div>
				</div>
				<div class="form-group">
					...
					<s:url action="edit" var="editGuiFragmentActionVar"><s:param name="code" value="#codeVar"/></s:url>
						...
						<td>
							<s:if test="null != #guiFragmentVar.pluginCode">
								<s:text name="%{#guiFragmentVar.pluginCode+'.name'}" />&nbsp;<code><s:property value="#guiFragmentVar.pluginCode"/></code>
							</s:if>
							<s:else>&ndash;</s:else>
						</td>
					</tr>
