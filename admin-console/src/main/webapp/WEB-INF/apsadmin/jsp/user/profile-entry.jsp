...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
    ...
    <li class="page-title-container"><s:text name="title.userProfile.edit" /></li>
</ol>
    ...
    <s:form cssClass="form-horizontal">
        ...
        <div class="col-xs-12">
            <div class="form-group">
                <label class="col-sm-2 control-label" for="profileType"><s:text name="label.type"/></label>
                <div class="col-sm-8">
                    <span class="spacer-right-on-form" ><s:property value="userProfile.typeDescription" /></span>
                </div>
            </div>
            <div class="form-group "> 
                <label class="col-sm-2"></label>
                <div class="col-sm-8 button-position-on-save">
                    <wpsf:submit action="changeProfileType" value="%{'('+getText('label.change')+')'}" cssClass="btn btn-primary" />
                </div>
            </div>
            <hr>
            <div class="form-group">
