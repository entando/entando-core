            ...
            <table class="table table-striped table-bordered">
                ...
                <s:iterator value="#userProfileVar.attributeList" var="attribute">
                    <tr>
                        ...
                        <th class="td-pagetree-width"><s:property value="#attributeLabelVar" /></th>
                        <td>
...
<div class="form-group "> 
    <div class="col-sm-12">
        <a class="btn btn-primary pull-right" href="<s:url namespace="/do/User" action="list" />" ><s:text name="note.userprofile.returnTo.search" /></a> 
    </div>
</div>
