...
<ol class="breadcrumb page-tabs-header breadcrumb-position">
    ...
    <li class="page-title-container"><s:if test="getStrutsAction() == 1">
...
<s:form action="save" cssClass="form-horizontal">
    ...
    <div class="form-group<s:property value="#controlGroupErrorClassVar" />">
        <div class="col-xs-12">
            <label class="control-label col-sm-2" for="description"><s:text name="label.name" /></label>
            <div class="col-xs-10">
    ...
    <div class="form-group<s:property value="#controlGroupErrorClassVar" />">
        <div class="col-xs-12">
            <label class="control-label col-sm-2" for="name"><s:text name="label.code" /></label>
            <div class="col-xs-10">
        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-10 col-10-checkbox-list">
                <s:iterator value="%{systemPermissions}" var="permissionVar">
                    <div class="col-xs-4">
                        <label>
                            <input type="checkbox" class="bootstrap-switch" name="permissionNames"  value="<s:property value="%{#permissionVar.name}" />" 
