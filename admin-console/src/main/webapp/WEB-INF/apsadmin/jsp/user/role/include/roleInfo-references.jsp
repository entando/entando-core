...
<s:form cssClass="form-horizontal">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2"><s:text name="title.role.referencedUsers" /></label>
                ...
                <wpsa:subset source="references" count="10" objectName="userReferences" advanced="true" offset="5" pagerId="userManagerReferences">
                    ...
                    <table class="table table-bordered" id="userListTable">
                        <tr>
                            ...
                            <th style="width:20px" class="text-center"><s:text name="label.state" /></th>
                            <th style="width:20px" class="text-center <c:out value="${canEditUser ? '' : ' hide'}" />"><s:text name="label.actions" /></th>
                        </tr>
                        ...
                        <s:iterator var="usernameVar">
                            ...
                            <tr>
                                ...
                                <%-- username --%>
                                <td><s:property value="#usernameVar" />
                                    <%-- last login --%>
                                ...
                                <%-- actions --%>
                                <td class="text-center <c:out value="${canEditUser ? '' : ' hide'}" />">
                                    ...
                                    <div class="dropdown dropdown-kebab-pf">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">	
                                            <c:if test="${canEditUser == 'true'}">
                                                <li>
                                                    <%-- edit user button --%>
                                                    <a href="<s:url namespace="/do/User" action="edit"><s:param name="username" value="#usernameVar"/></s:url>" 
                                                ...
                                                <li>
                                                    ...
                                                    <a  href="<s:url action="edit" namespace="/do/User/Authorization"><s:param name="username" value="#usernameVar"/></s:url>"
