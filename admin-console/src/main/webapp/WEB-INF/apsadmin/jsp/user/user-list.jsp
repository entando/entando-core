...
<h1 class="page-title-container"><s:text name="title.userManagement" />
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <!--users section end-->
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="userprofile_src_entityPrototypes" >
                            ...
                            <s:if test="null != #searchableAttributesVar && #searchableAttributesVar.size() > 0">
                                <s:iterator value="#searchableAttributesVar" var="attribute">
                                    ...
                                    <s:if test="#attribute.textAttribute">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" style="text-align:end" for="<s:property value="#currentAttributeHtmlId" />"><s:property value="#attribute.name" /></label>
                                            <div class="col-sm-8">
                                    ...
                                    <s:elseif test="#attribute.type == 'Date'">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" style="text-align:end"><s:property value="#attribute.name" /></label>
                                            <div class="col-sm-8">
                                    ...
                                    <s:elseif test="#attribute.type == 'Boolean' || #attribute.type == 'ThreeState'">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3 "><s:property value="#attribute.name" /></label>
                                    ...
                                    <s:else>
                                        ...
                                        <s:set var="textInputFieldName" value="%{#attribute.name+'_textFieldName'}" />
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" style="text-align:end" for="<s:property value="#currentAttributeHtmlId" />">
