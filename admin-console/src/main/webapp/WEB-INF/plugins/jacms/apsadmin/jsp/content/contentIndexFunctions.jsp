	...
	<s:form class="form-horizontal" action="updateSystemParams">
		...
		<div class="form-group">
			<div class="col-xs-2 control-label">
				<span class="display-block"><s:text name="title.reload.contentReferences"/></span>
			</div>
			<div class="col-xs-10 ">
				<div class="btn-group">
					<s:if test="contentManagerStatus == 1">
						<p class="text-info">
							<a class="btn btn-default" href="<s:url action="openIndexProspect" namespace="/do/jacms/Content/Admin" />" title="<s:text name="note.reload.contentReferences.refresh" />">
					...
					<s:else>
						<p>
							<a class="btn btn-default" href="<s:url action="reloadContentsReference" namespace="/do/jacms/Content/Admin" />">
			...
			<div class="col-xs-10 ">
				<div class="btn-group">
					<s:if test="searcherManagerStatus == 1">
						<p class="text-info">
							<a class="btn btn-default" href="<s:url action="openIndexProspect" namespace="/do/jacms/Content/Admin" />" title="<s:text name="note.reload.contentIndexes.refresh" />">
								<s:text name="label.refresh" />
							</a>
					...
					<s:else>
						<p>
							<a class="btn btn-default" href="<s:url action="reloadContentsIndex" namespace="/do/jacms/Content/Admin" />">
