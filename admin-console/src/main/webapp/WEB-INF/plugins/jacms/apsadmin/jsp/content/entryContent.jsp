...
<h1 class="page-title-container">
    <%-- TODO: definire comportamento del Go Back 
...
<div id="main" role="main" class="mt-20">
	...
	<s:form cssClass="tab-container form-horizontal col-xs-12 mt-40" data-form-type="autosave" data-autosave-action="%{#dataAutosaveActionVar}">
            ...
            <div class="form-group<s:property value="#controlGroupErrorClass" />">
                <label class="col-sm-2 control-label" for="contentMainGroup">
                    ...
                    <a tabindex="0" role="button" data-toggle="popover" 
                        ...
                        data-content="<s:text name="note.set.MainGroup" />." 
			                ...
			                <div class="input-group">
			                    ...
			                    <span class="input-group-btn">
			                        <wpsf:submit action="configureMainGroup"
			                            type="button" title="Set Group" cssClass="btn btn-default">
        ...
        <div class="section-divider-wrapper form-group">
            <div class="row">
                <div class="col-sm-2">
                    <span class="section-divider">3</span> <span class="control-label label-group-name"><s:text name="label.categories" /></span>
                </div>
                <div class="col-sm-10 text-right">
                    <div class="form-group-separator"><s:text name="label.requiredFields" /></div>
                </div>
        ...
        <div class="section-divider-wrapper form-group">
            <div class="row">
                <div class="col-sm-2">
                    <span class="section-divider">4</span> <span class="control-label label-group-name"><s:text name="label.customAttributes" /></span>
                </div>
                <div class="col-sm-10 text-right">
                    <div class="form-group-separator"><s:text name="label.requiredFields" /></div>
                </div>
						...
						<div id="<s:property value="%{'contentedit_'+#lang.code+'_'+#attribute.name}" />"><%-- contentedit div --%>
							...
							<div class="form-group<s:property value="#controlGroupErrorClassVar" />"><%-- form group --%>
								<s:if test="#attribute.type == 'List' || #attribute.type == 'Monolist'">
										<label class="col-sm-2 control-label"><span class="icon fa fa-list"></span>&#32;<s:property value="#attributeLabelVar" />&#32;<s:include value="/WEB-INF/apsadmin/jsp/entity/modules/include/attributeInfo.jsp" /></label>
								</s:if>
								...
								<s:elseif test="#attribute.type == 'Composite'">
										<label class="col-sm-2 control-label"><span class="icon fa fa-list-alt"></span>&#32;<s:property value="#attributeLabelVar" />&#32;<s:include value="/WEB-INF/apsadmin/jsp/entity/modules/include/attributeInfo.jsp" /></label>
								</s:elseif>
