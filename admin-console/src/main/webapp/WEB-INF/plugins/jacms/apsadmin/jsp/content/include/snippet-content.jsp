    ...
    <div class="form-group">
        ...
        <div class=" col-sm-10">
            ...
            <span data-autosave="firstEditor">
                ...
                <c:if test="${!empty firstEditorVar && authorizedSuperUserVar}">
                    <a href="<s:url action="edit" namespace="/do/User">
                           <s:param name="username" value="content.firstEditor"/></s:url>" 
                       title="<s:text name="label.edit" />: <s:property value="content.firstEditor" />">
                    </c:if>
                    <c:choose>
                        <c:when test="${empty firstEditorVar || (firstEditorVar eq sessionScope.currentUser)}"><s:property value="content.firstEditor" /> 
                            <span class="label label-info"><s:text name="label.you" /></span>
                        </c:when>
