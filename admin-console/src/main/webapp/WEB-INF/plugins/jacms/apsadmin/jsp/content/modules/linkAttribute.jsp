	        ...
	        <div class="form-group">
		        ...
		        <s:if test="#validLink">
		            ...
		            <s:if test="#attribute.symbolicLink.destType == 4">
			         ...
			         <div class="col-xs-12">
						<label class="col-sm-1 text-right no-padding pr-10"><abbr title="${linkType}"><s:text name="label.URL" /></abbr>:</label>
...
<s:else>
	<wpsf:submit cssClass="btn btn-default btn-long" type="button" action="%{#chooseLinkActionName}" title="%{#attribute.name + ': ' + getText('label.configure')}">
		<span class="sr-only"><s:property value="#attribute.name" />:</span>
