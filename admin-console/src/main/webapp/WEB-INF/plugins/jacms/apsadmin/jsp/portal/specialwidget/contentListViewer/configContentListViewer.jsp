			...
			<div class="panel-body">
				...
				<fieldset class="col-xs-12 no-padding">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<wpsf:select name="contentType" id="contentType" list="contentTypes" 
								listKey="code" listValue="descr" disabled="true" 
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<wpsf:submit action="changeContentType" 
								value="%{getText('label.change')}" cssClass="btn btn-default" />
						</div>				
					</div>
				...
				<fieldset class="col-xs-12 no-padding">
					...
					<div class="collapse" id="options-publishing">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<wpsf:select name="modelId" id="modelId" 
									value="%{getShowlet().getConfig().get('modelId')}"
									list="%{getModelsForContentType(widget.config['contentType'])}" headerKey="" 
				...
				<fieldset class="col-xs-12 no-padding">
					...
					<div class="collapse" id="filters">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<wpsf:submit type="button" action="addCategory" 
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<wpsf:select name="filterKey" id="filterKey" list="allowedFilterTypes" 
									listKey="key" listValue="value" cssClass="form-control" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<wpsf:submit type="button" action="setFilterType"  
									cssClass="btn btn-default">
		                     ...
		                     <s:if test="%{widget.type.hasParameter('linkDescr_%')}" >
		                         <s:iterator var="lang" value="langs">
		                             <div class="form-group">
		                                 ...
		                                 <div class="col-sm-10">
		                                     <wpsf:textfield name="linkDescr_%{#lang.code}" 
		                                     	id="linkDescr_%{#lang.code}" 
		             ...
		             <fieldset class="col-xs-12 no-padding">
		                 ...
		                 <div class="collapse" id="filters-frontend">
		                     <div class="form-group">
		                         ...
		                         <div class="col-sm-10">
	                                 <wpsf:select name="userFilterKey" id="userFilterKey" 
	                                 	list="allowedUserFilterTypes" listKey="key" 
	                                 	listValue="value" cssClass="form-control" />
		                         </div>
		                     </div>
		                     <div class="form-group">
			                     <div class="col-sm-offset-2 col-sm-10">
			                         <wpsf:submit type="button" action="addUserFilter" 
			                         	cssClass="btn btn-default">
			                             <s:text name="label.add" />
			                         </wpsf:submit>
			                     </div>
