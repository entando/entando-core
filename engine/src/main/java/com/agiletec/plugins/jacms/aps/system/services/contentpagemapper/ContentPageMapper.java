...
/**
 * Rappresentazione della mappa dei contenuti pubblicati esplicitamene nelle
 * pagine del portale.
 *
 * @author W.Ambu
 */
public class ContentPageMapper implements Serializable {
     ...
     * @param pageCode Il codice della pagina nel quale e' publicato il
     * contenuto.
     */
    ...
    /**
     * Restituisce il codice pagina nel quale e' stato publicato il contenuto
     * specificato. Restituisce null nel caso in cui l'id del contenuto non sia
     * presente nella mappa.
     *
     * @param contentId L'id del contenuto.
     * @return Il codice pagina nel quale e' stato publicato il contenuto
     * specificato.
     */
    ...
    /**
     * Verifica se un contenuto e' stato pubblicato esplicitamente in una
     * pagina.
     *
     * @param contentId L'id del contenuto.
     * @return true se un contenuto e' stato pubblicato esplicitamente in una
