...
public class OAuthTokenRequest extends AbstractOAuthTokenRequest {
     ...
     *
     * @param request the httpservletrequest that is validated and transformed
     * into the OAuth Token Request
     * @throws OAuthSystemException if an unexpected exception was thrown
     * @throws OAuthProblemException if the request was not a valid Token
