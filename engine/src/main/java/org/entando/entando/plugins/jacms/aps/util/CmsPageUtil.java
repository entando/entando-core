...
public class CmsPageUtil {
	...
	/**
	 * Check if is possible to publish the content in the given page, checking its online configuration.
	...
	/**
	 * Check if is possible to publish the content in the given page, checking its draft configuration.
	 * @param publishingContent The publishing content.
	 * @param page The page where you want to publish the content.
	 * @return True/false if is possible to publish the content in the given page.
	 */
	...
	/**
	 * Check if is possible to publish the content in the given page, checking the given page metadata.
	 * @param publishingContent The publishing content.
	 * @param page The page where you want to publish the content.
	 * @param metadata The metadata of the page where you want to publish the content.
	 * @return True/false if is possible to publish the content in the given page.
	 */
	...
	/**
	 * Check if is possible to link a page by the given content, checking the page in its online configuration.
	...
	/**
	 * Check if is possible to link a page by the given content, checking the page in its draft configuration.
	 * @param page The page to link.
	 * @param content The content where link the given page.
	 * @return True/false if is possible to link the page in the given content.
	 */
	...
	/**
	 * Check if is possible to link a page by the given content, checking the given page metadata.
	 * @param page The page to link.
	 * @param metadata The metadata of the page you want to link in the given content.
	 * @param content The content where link the given page.
	 * @return True/false if is possible to link the page in the given content.
	 */
