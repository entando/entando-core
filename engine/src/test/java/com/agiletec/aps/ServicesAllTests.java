...
import org.entando.entando.aps.system.services.digitalexchange.marketplace.MarketplacesServiceTest;
...
public class ServicesAllTests extends TestCase {
    ...
    public static Test suite() {
        ...
        suite.addTest(new JUnit4TestAdapter(MarketplacesServiceTest.class));
        return suite;
    }
