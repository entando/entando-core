...
public class TestContentDispenser extends BaseTestCase {
	...
	public void testGetRenderedContent_3() throws Throwable {
		...
		try {
			...
			assertNotNull(this._cacheInfoManager.getFromCache(ICacheInfoManager.DEFAULT_CACHE_NAME, JacmsSystemConstants.CONTENT_CACHE_PREFIX + content.getId()));
			...
			assertNull(this._cacheInfoManager.getFromCache(ICacheInfoManager.DEFAULT_CACHE_NAME, JacmsSystemConstants.CONTENT_CACHE_PREFIX + content.getId()));
