...
public class ApiCatalogManagerCacheWrapperTest {

	private static final String CACHE_NAME = IApiCatalogManagerCacheWrapper.APICATALOG_MANAGER_CACHE_NAME;
	...
	public void setUp() throws Exception {
		...
		fakeCache.put(IApiCatalogManagerCacheWrapper.APICATALOG_SERVICES_CACHE_NAME, new HashMap<String, ApiService>());
